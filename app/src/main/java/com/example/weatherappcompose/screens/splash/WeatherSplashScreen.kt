package com.example.weatherappcompose.screens.splash
...
import com.example.weatherappcompose.navigation.WeatherScreens
...
fun WeatherSplashScreen(navController: NavController? = null) {
    ...
    Surface(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.sun_glow),
